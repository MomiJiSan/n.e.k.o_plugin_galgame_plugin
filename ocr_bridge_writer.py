...
from .ocr_backend_interface import CaptureBackend as CaptureBackend
from .ocr_backend_interface import OcrBackend as OcrBackend
from .ocr_runtime_types import OcrBackendDescriptor as OcrBackendDescriptor
from .ocr_runtime_types import OcrCaptureProfile as OcrCaptureProfile
from .ocr_runtime_types import OcrExtractionResult as OcrExtractionResult
from .ocr_runtime_types import OcrReaderTickResult as OcrReaderTickResult
from .ocr_runtime_types import OcrTextBox as OcrTextBox
from .ocr_runtime_types import OcrWindowTarget as OcrWindowTarget
from .ocr_runtime_types import ParsedOcrCaptureProcessConfig as ParsedOcrCaptureProcessConfig
from .ocr_runtime_types import ResolvedOcrCaptureSelection as ResolvedOcrCaptureSelection
from .ocr_runtime_types import SelectedOcrBackendPlan as SelectedOcrBackendPlan
from .ocr_runtime_types import WindowSelectionResult as WindowSelectionResult
