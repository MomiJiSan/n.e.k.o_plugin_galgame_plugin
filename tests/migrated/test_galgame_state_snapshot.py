...
from market_plugins.galgame_plugin.models import ADVANCE_SPEED_MEDIUM, MODE_COMPANION
from market_plugins.galgame_plugin.state import build_initial_state
...
class _FakePlugin:
    ...
    def _snapshot_state(self, *, fresh=False):
        from market_plugins.galgame_plugin.models import json_copy
