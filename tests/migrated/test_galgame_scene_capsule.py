...
import pytest
from market_plugins.galgame_plugin.agent_scene_tracker import AgentSceneTracker
from market_plugins.galgame_plugin.game_llm_agent import GameLLMAgent
...
GalgameBridgePlugin = SceneCapsulePlugin
