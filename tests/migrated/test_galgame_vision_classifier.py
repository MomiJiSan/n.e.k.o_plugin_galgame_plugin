...
from market_plugins.galgame_plugin.core.vision.vision_classifier import (
    GALGAME_VISION_LABELS,
    VisionScreenClassifier,
)
from market_plugins.galgame_plugin.core.vision.vision_model_loader import VisionModelLoader
...
def test_vision_model_loader_keeps_cpu_provider_as_fallback(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "market_plugins.galgame_plugin.core.vision.vision_model_loader.ort",
        _FakeOrt,
    )
