...
character_profile_module = import_module(
    "market_plugins.galgame_plugin.character_profile"
)
...
state_module = import_module("market_plugins.galgame_plugin.state")

CharacterProfileManager = character_profile_module.CharacterProfileManager
GalgamePlugin = plugin_core_module.GalgamePlugin
build_initial_state = state_module.build_initial_state
ADVANCE_SPEED_MEDIUM = models_module.ADVANCE_SPEED_MEDIUM
MODE_COMPANION = models_module.MODE_COMPANION
STORE_CHARACTER_FIXED_NAME = models_module.STORE_CHARACTER_FIXED_NAME
STORE_CHARACTER_MODE = models_module.STORE_CHARACTER_MODE
STORE_CHARACTER_PROFILE_VERSION = models_module.STORE_CHARACTER_PROFILE_VERSION
STORE_CHARACTER_PROFILES = models_module.STORE_CHARACTER_PROFILES
STORE_CHARACTER_RUNTIME_STATE = models_module.STORE_CHARACTER_RUNTIME_STATE
